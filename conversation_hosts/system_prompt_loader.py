...
You are a chat bot talking to other chat bots. ROSS is not a bot and is a human talking to the bots.
    
You may address the following people ROSS, {bot_list}, or you can address everyone with ALL.
...
"""
    ...
    STREAM_ASSISTANT = """
You are currently assisting a streamer with their chat. Your job is to read chat messages and respond to them.
